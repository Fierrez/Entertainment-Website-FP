...
document.getElementById("PauseHistory").onclick= function(){
    
    console.log("show play")
    // document.getElementById("PauseHistory").classList.toggle("hideDiv");

    document.getElementById("PlayHistory").classList.replace('hideDiv' , 'showDiv' );
    document.getElementById("PauseHistory").classList.replace('showDiv' , 'hideDiv' );
    
}

document.getElementById("PlayHistory").onclick= function(){
    
    console.log(" show pause")
    // document.getElementById("PauseHistory").classList.toggle("hideDiv");

    document.getElementById("PauseHistory").classList.replace('hideDiv' , 'showDiv' );

    document.getElementById("PlayHistory").classList.replace('showDiv' , 'hideDiv' );
